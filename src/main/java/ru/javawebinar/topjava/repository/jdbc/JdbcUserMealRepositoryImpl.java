...
public class JdbcUserMealRepositoryImpl implements UserMealRepository {
    ...
    private static final RowMapper<UserMeal> ROW_MAPPER = (rs, rowNum) -> new UserMeal(rs.getInt("id"), rs.getTimestamp("dateTime").toLocalDateTime(), rs.getString("description"), rs.getInt("calories"));
